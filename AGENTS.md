...
- Treat `docs/SPATIAL_SCENE_PACKAGE_V0_1.md` and its JSON Schema as the public
  v0.1 master contract; keep it distinct from the runtime `spatial_core_scene/2.0` format.
