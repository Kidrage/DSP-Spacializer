...
def _dummy_scene_and_audio(sr=48000):
    ...
    routing = {"bass_gain": 1.0, "side_front": 0.4, "side_rear": 0.6, "amb_rear": 0.7, "air_rear": 0.4, "decorrelation": 0.2, "lowbody_rear": 0.2}
    scene = build_pseudo_object_scene("dummy.wav", layers["front_L"], layers["front_R"], layers, analysis, routing, "auto_acoustic", "auto_acoustic", sr, 1.0, export_object_audio=False)
    return scene, build_object_audio_for_scene(layers)


def test_decode_shape_and_finiteness():
